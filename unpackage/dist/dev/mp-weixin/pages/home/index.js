  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        b: common_vendor.t(carInfo.value.brand),
        c: common_vendor.t(carInfo.value.model),
        d: common_vendor.t(carInfo.value.trim),
        e: common_vendor.t(oilPrice.value.label),
        f: common_vendor.t(oilPrice.value.value),
        ...
        p: common_vendor.f(actions.value, (action, k0, i0) => {
          return {
