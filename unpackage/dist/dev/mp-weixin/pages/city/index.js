...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const locationProvince = common_vendor.ref("");
    ...
    const handleLocate = async (applyCity = true) => {
      ...
      try {
        ...
        common_vendor.index.__f__("log", "at pages/city/index.vue:257", 273, "located = ", located);
    ...
    const handlePickFromMap = async () => {
      ...
      common_vendor.index.__f__("log", "at pages/city/index.vue:289", 305, "result = ", result);
